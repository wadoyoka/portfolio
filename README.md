...
Next.js 14とmicroCMSを使用したポートフォリオサイトです。

制作物の紹介やブログ記事を掲載しており、タグによるフィルタリングや検索機能を備えています。動的OGP画像生成やサイトマップ自動生成など、SEOにも配慮した設計になっています。

環境変数を設定することで、名前やサイトURLなどをカスタマイズできます。
